  ...
  return (
    <div className="min-h-screen text-gray-800 font-sans bg-gradient-to-r from-blue-200 to-cyan-200">
      ...
      <main className="flex flex-col items-center justify-center min-h-screen">
        <section className="flex flex-col sm:flex-row items-start sm:items-center mt-8">
          ...
          <div className="bg-white p-6 sm:w-1/2 w-full rounded-lg mt-8 shadow-lg" style={{ marginRight: '20px' }}>
            <div className="bg-gradient-to-r from-blue-200 to-cyan-200 p-6 rounded-lg">
              <Input
